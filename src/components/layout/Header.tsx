  ...
  return (
    <header className="flex min-h-16 items-center justify-between gap-4 border-b border-white/10 bg-primary px-4 py-3 text-primary-foreground sm:px-6">
      <div className="flex min-w-0 items-center gap-3">
        <button
          type="button"
          className="grid h-11 w-11 shrink-0 place-items-center rounded-xl text-primary-foreground transition hover:bg-navy focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent lg:hidden"
          aria-label={
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <div className="w-[120px]">
          <Button type="button" variant="default" className="bg-accent hover:bg-accent/90" onClick={handleSignOut}>
            Sign out
          </Button>
        </div>
      </div>
