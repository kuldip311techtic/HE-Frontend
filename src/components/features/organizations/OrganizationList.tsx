        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-line text-left">
            ...
            <thead className="bg-accent-soft/40">
              <tr>
                <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wide text-muted sm:px-6">
                  Name
                </th>
                <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wide text-muted sm:px-6">
                  Email
                ...
                <th scope="col" className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-muted sm:px-6">
                  Actions
                </th>
              </tr>
            </thead>
