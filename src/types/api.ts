...
export interface SubscriptionPlanMutationResponse extends SubscriptionPlanItem {
  message?: string;
}
...
/** @deprecated Use DashboardAnalyticsResponse */
export type SuperAdminDashboardResponse = DashboardAnalyticsResponse;
